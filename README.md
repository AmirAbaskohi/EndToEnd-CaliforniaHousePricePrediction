...
This notebook is based on Chapter 2 of `Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow, 2nd Edition` by `Aurélien Géron`
...
>>> housing.info()
 ...
 ## How to run?
 To see project first install `Jupyter Notebook` using:
 ```
 pip install jupyter
 ```
